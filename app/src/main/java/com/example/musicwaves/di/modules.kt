...
import com.example.musicwaves.storage.data_sources.local.albums.LocalAlbumsDataSource
import com.example.musicwaves.storage.data_sources.local.albums.LocalAlbumsDataSourceImpl
import com.example.musicwaves.storage.data_sources.local.tags.LocalTagsDataSource
import com.example.musicwaves.storage.data_sources.local.tags.LocalTagsDataSourceImpl
import com.example.musicwaves.storage.data_sources.local.tracks.LocalTracksDataSource
import com.example.musicwaves.storage.data_sources.local.tracks.LocalTracksDataSourceImpl
import com.example.musicwaves.storage.data_sources.remote.albums.RemoteAlbumsDataSource
import com.example.musicwaves.storage.data_sources.remote.albums.RemoteAlbumsDataSourceImpl
import com.example.musicwaves.storage.data_sources.remote.tags.RemoteTagsDataSource
import com.example.musicwaves.storage.data_sources.remote.tags.RemoteTagsDataSourceImpl
import com.example.musicwaves.storage.data_sources.remote.tracks.RemoteTracksDataSource
import com.example.musicwaves.storage.data_sources.remote.tracks.RemoteTracksDataSourceImpl
import com.example.musicwaves.storage.local.*
import com.example.musicwaves.storage.repository.AlbumsRepositoryImpl
import com.example.musicwaves.storage.repository.TagsRepositoryImpl
import com.example.musicwaves.storage.repository.TracksRepositoryImpl
